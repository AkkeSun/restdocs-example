...
/*
    실패, 성공 케이스를 나누어 테스트코드를 작성한다
    작성후 테스트에 성공하면  build > generated-snippets 에 adoc 문서가 생성된다
    ./gradlew asciidoctor 호출시 src > docs > asciidoc > inddex.adoc generated-snippets 에 있는 파일을 기반으로 API 문서가 생성된다
 */
class FindUserNameDocsTest extends RestDocsSupport {
    ...
    void success () throws Exception {
        ...
        actions.andDo(print())
            ...
            .andDo(MockMvcRestDocumentationWrapper.document("getUserInfo/success", // generated-snippets 하위에 adoc 파일이 생성되는 경루
    ...
    void fail1 () throws Exception {
        ...
        actions.andDo(print())
            ...
            .andDo(MockMvcRestDocumentationWrapper.document("getUserInfo/userIdNotCommand",
                    preprocessRequest(prettyPrint()),
                    preprocessResponse(prettyPrint()),
                    ResourceDocumentation.resource(ResourceSnippetParameters.builder()
                        .tag("USER API")
