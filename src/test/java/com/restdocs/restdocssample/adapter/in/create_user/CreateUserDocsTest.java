...
class CreateUserDocsTest extends RestDocsSupport {
    ...
    void success () throws Exception {
        ...
        actions.andDo(print())
            ...
            .andDo(MockMvcRestDocumentationWrapper.document("createUser/success",
    ...
    void fail () throws Exception {
        ...
        actions.andDo(print())
            ...
            .andDo(MockMvcRestDocumentationWrapper.document("createUser/ageIsNull",
                    preprocessRequest(prettyPrint()),
                    preprocessResponse(prettyPrint()),
                    ResourceDocumentation.resource(ResourceSnippetParameters.builder()
                        .tag("USER API")
                        .summary("사용자 등록 API - 필수값 미입력")
                        .requestFields( // request body info
                            fieldWithPath("name").type(JsonFieldType.STRING).description("사용자 이름"),
                            fieldWithPath("age").type(JsonFieldType.NUMBER).description("사용자 나이")
                        )
